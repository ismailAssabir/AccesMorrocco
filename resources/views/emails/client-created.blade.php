...
<body>
    <div class="container">
        ...
        <div class="body">
            <p class="greeting">Bonjour {{ $client->firstName }} {{ $client->lastName }} 👋</p>

            <p class="text">
                Votre dossier a été créé avec succès. Vous pouvez maintenant accéder à votre espace client pour suivre
                vos voyages, consulter vos documents et vérifier vos paiements.
            </p>
            ...
            <a href="{{ url('/clients/login') }}" class="btn">
                Accéder à mon espace →
            </a>

            <div class="warning">
                ⚠️ Pour votre sécurité, nous vous recommandons de changer votre mot de passe lors de votre première
                connexion.
            </div>
        </div>
