...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::patch('/reclamation/reponse/{id}', [ReclamationController::class, 'reponse']);
    Route::get('/reclamation/{id}', [ReclamationController::class, 'show']);
    Route::resource('reclamations', ReclamationController::class)->except(['create', 'edit', 'show']);

    // Congés
    Route::put('/conge/update/{id}', [CongeController::class, 'update']);
    ...
    Route::patch('/tasks/{id}/status', [TacheController::class, 'status'])->name('tasks.status');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/pointage/justification/{id}/validate', [PointageController::class, 'validateJustification'])->name('justification.validate');
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::post('/admin/pointages/clear', [PointageController::class, 'clearHistory'])->name('admin.pointages.clear');
