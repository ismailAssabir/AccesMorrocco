<x-app-layout>
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-black text-slate-800">{{ number_format($primes->sum('montant'), 2) }} MAD</p>
                    </div>
                </div>
            </div>
            <div class="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-black text-slate-800">{{ $primes->where('status', 'en_attente')->count() }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-black text-slate-800">{{ $primes->where('status', 'payee')->count() }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="modal-create-prime" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4">
        <div class="bg-white rounded-3xl shadow-xl w-full max-w-lg flex flex-col overflow-hidden">
            ...
            <form action="{{ route('primes.store') }}" method="POST" class="p-6 space-y-4">
                @csrf
                <div>
