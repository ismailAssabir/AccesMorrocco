    ...
    <div class="login-right">
        <div class="w-full max-w-[480px]">
            ...
            <div class="auth-card">
                ...
                <form method="POST" action="{{ route('clients.login.post') }}" class="space-y-5">
                    @csrf
            ...
            <p class="text-center text-xs text-slate-400 mt-6">
                Employee access? 
                <a href="{{ route('login') }}" class="text-[#b11d40] font-bold hover:underline">
                    Go to staff login →
                </a>
            </p>
        </div>
