                    ...
                    <td class="px-6 py-4">
                        <div class="flex -space-x-2">
                            <?php $__currentLoopData = $tache->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="w-8 h-8 rounded-xl bg-gradient-to-tr from-slate-100 to-slate-200 border-2 border-white flex items-center justify-center text-[10px] font-black text-[#be2346] shadow-sm transition-transform hover:scale-110 hover:z-10 cursor-help" title="<?php echo e($u->firstName); ?> <?php echo e($u->lastName); ?>">
...
<?php /**PATH C:\Users\dell\Desktop\PROJECTS\AccesMorrocco\resources\views/taches/partials/table.blade.php ENDPATH**/ ?>