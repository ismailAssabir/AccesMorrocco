...
<body>
    <div class="header">
        ...
        <div class="company-info">
            ...
            <p style="font-size: 11px; color: #64748b; margin: 4px 0;">Généré le: <?php echo e($date); ?></p>
    ...
    <div class="filters-info">
        <strong>Période:</strong> <?php echo e(ucfirst($filters['period'])); ?> 
        <?php if($filters['start']): ?> (<?php echo e($filters['start']); ?> — <?php echo e($filters['end']); ?>) <?php endif; ?>
        <span style="margin: 0 15px; color: #cbd5e1;">|</span>
        <strong>Rôle:</strong> <?php echo e(ucfirst($filters['role'] ?: 'Tous')); ?>

        <span style="margin: 0 15px; color: #cbd5e1;">|</span>
        <strong>Statut:</strong> <?php echo e(ucfirst($filters['status'] ?: 'Tous')); ?>

        <span style="margin: 0 15px; color: #cbd5e1;">|</span>
        <strong>Justificatif:</strong> <?php echo e($filters['justified'] === 'yes' ? 'Avec' : ($filters['justified'] === 'no' ? 'Sans' : 'Tous')); ?>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card" style="border-left: 4px solid #10b981;">
            ...
            <div class="stat-value" style="color: #059669;"><?php echo e($stats['presents']); ?></div>
        </div>
        <div class="stat-card" style="border-left: 4px solid #f59e0b;">
            <div class="stat-label">Retards</div>
            <div class="stat-value" style="color: #d97706;"><?php echo e($stats['retards']); ?></div>
        </div>
        <div class="stat-card" style="border-left: 4px solid #ef4444;">
            <div class="stat-label">Absents</div>
            <div class="stat-value" style="color: #dc2626;"><?php echo e($stats['absents']); ?></div>
        </div>
    </div>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                <?php $__currentLoopData = $pointages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $user = $p->user;
                        $empName = $user ? $user->firstName . ' ' . $user->lastName : 'Inconnu';
                    ?>
                    <tr>
                        <td style="font-weight: bold; color: #1e293b;"><?php echo e(\Carbon\Carbon::parse($p->date)->format('d/m/Y')); ?></td>
                        <td>
                            <strong style="color: #1e293b;"><?php echo e($empName); ?></strong><br>
                            <span style="font-size: 9px; color: #94a3b8;"><?php echo e($user->email ?? ''); ?></span>
                        </td>
                        <td><span style="text-transform: capitalize;"><?php echo e($user->type ?? '--'); ?></span></td>
                        <td>
                            <?php if($p->heureEntree): ?>
                                <span style="font-weight: bold; color: #10b981;"><?php echo e(\Carbon\Carbon::parse($p->heureEntree)->format('H:i')); ?></span>
                            <?php else: ?>
                                <span style="color: #cbd5e1;">--:--</span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php if($p->heureSortie): ?>
                                <span style="font-weight: bold; color: #6366f1;"><?php echo e(\Carbon\Carbon::parse($p->heureSortie)->format('H:i')); ?></span>
                            <?php else: ?>
                                <span style="color: #cbd5e1;">--:--</span>
                            <?php endif; ?>
                        </td>
                        <td>
                            ...
                            ?>
                            <span style="font-weight: bold; color: #475569;"><?php echo e($duree); ?></span>
                        </td>
                        <td>
                            <span class="status-badge status-<?php echo e($p->status); ?>">
                        ...
                        <td>
                            <?php if($p->justification): ?>
                                <div style="font-size: 9px; line-height: 1.2;">
                                    <strong><?php echo e($p->typejustif); ?></strong><br>
                                    <?php echo e(Str::limit($p->justification, 50)); ?>
