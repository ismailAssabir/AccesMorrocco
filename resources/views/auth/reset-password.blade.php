{{-- ============================================================
     PREMIUM SAAS PASSWORD RESET PAGE — ACCESS MOROCCO
...
<div class="login-wrapper">
    ...
    {{-- ══════════════════════════════════════════════════
         ...
         Identical to login for brand consistency
    ══════════════════════════════════════════════════ --}}
    <div class="login-left">
        ...
        <div class="login-left-content">
            ...
            <p class="login-left-footer">
                &copy; {{ date('Y') }} ACCESS MOROCCO. Secure Infrastructure.
            </p>
        </div>
    </div>
        ...
        <div class="w-full max-w-[440px]">
            ...
            <div class="card">
                <div class="auth-card">
                    ...
                    {{-- ── Reset Form ── --}}
                    <form method="POST" action="{{ route('password.store') }}" class="mt-7 space-y-5" id="reset-form">
                        @csrf
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100 text-center">
                        <a href="{{ route('login') }}" class="text-sm font-medium text-gray-500 hover:text-brand-600 transition-colors duration-200 flex items-center justify-center gap-1.5">
