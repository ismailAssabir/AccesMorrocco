...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">Bonjour {{ $client->firstName }},</div>
            <p class="message">
            ...
            <div class="card">
                ...
                <div class="card-value">{{ $presentation->titre }}</div>
                
                <div style="margin-top: 16px;">
                    <div class="card-title">Destination</div>
                    <div class="card-value">{{ $presentation->dossier->distination }}</div>
                </div>
            </div>

            <div class="btn-container">
                <a href="{{ route('clients.presentations.show', $presentation->idPresentation) }}" class="btn">
                    Voir ma présentation
                </a>
            </div>
        </div>
        <div class="footer">
            &copy; {{ date('Y') }} Access Morocco Experience. Tous droits réservés.<br>
