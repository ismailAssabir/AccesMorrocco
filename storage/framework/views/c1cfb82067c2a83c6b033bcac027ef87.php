...
<tr class="hover:bg-slate-50/80 transition-colors group">
    ...
    <td class="px-6 py-4 flex justify-end gap-3">
        <a href="/reclamation/<?php echo e($rec->idReclamation); ?>" class="p-2 rounded-lg text-slate-400 hover:bg-blue-50 hover:text-blue-600 transition-all shadow-sm bg-white border border-slate-200">
        ...
        <button onclick="confirmDeleteReclamation('<?php echo e($rec->idReclamation); ?>')" class="p-2 rounded-lg text-slate-400 hover:bg-red-50 hover:text-red-600 transition-all shadow-sm bg-white border border-slate-200">
...
<?php endif; ?>
<?php /**PATH C:\Users\ABA SOLUTIONS\Desktop\PROJET STAGE Travel Agency\AccesMorrocco\resources\views/partials/reclamations-table.blade.php ENDPATH**/ ?>