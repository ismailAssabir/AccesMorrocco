...
<?php endif; ?>
        ...
        <div id="objectifs-container" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <?php echo $__env->make('objectifs.partials.cards', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    ...
    <script>
        ...
        function fetchFilteredObjectifs() {
            ...
            let url = `<?php echo e(route('objectifs.index')); ?>?search=${encodeURIComponent(search)}&status=${status}&idDepartement=${idDepartement}`;
...
<?php endif; ?><?php /**PATH C:\Users\4B\Desktop\ExercicesLaravel\voyage\resources\views/objectifs/index.blade.php ENDPATH**/ ?>