                ...
                <a href="{{ route('dashboard') }}" 
                   ...
                   {{ request()->routeIs('dashboard') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
                    <div class="transition-transform duration-300 {{ request()->routeIs('dashboard') ? '' : 'group-hover:rotate-12' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('dashboard') ? 'text-white' : 'group-hover:text-[#be2346]' }} transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <nav class="space-y-1">
            ...
            @can('prime.view')
                <a href="{{ route('primes.index') }}" 
                   class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95
                   {{ request()->routeIs('primes.*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
                    <div class="transition-transform duration-300 {{ request()->routeIs('primes.*') ? '' : 'group-hover:rotate-12' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('primes.*') ? 'text-white' : 'group-hover:text-[#be2346]' }} transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @can('tache.view')
                <a href="{{ Route::has('tasks.index') ? route('tasks.index') : '#' }}" class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95 {{ request()->routeIs('tasks.*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
                    <div class="transition-transform duration-300 {{ request()->routeIs('tasks.*') ? '' : 'group-hover:rotate-12' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('tasks.*') ? 'text-white' : 'group-hover:text-[#be2346]' }} transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @can('reunion.view')
                <a href="{{ Route::has('reunions.index') ? route('reunions.index') : '#' }}" 
                   class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95
                   {{ request()->routeIs('reunions.*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
                    <div class="transition-transform duration-300 {{ request()->routeIs('reunions.*') ? '' : 'group-hover:rotate-12' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('reunions.*') ? 'text-white' : 'group-hover:text-[#be2346]' }} transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @can('objectif.view')
                <a href="{{ Route::has('objectifs.index') ? route('objectifs.index') : '#' }}" 
                   class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95
                   {{ request()->routeIs('objectifs.*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
                    <div class="transition-transform duration-300 {{ request()->routeIs('objectifs.*') ? '' : 'group-hover:rotate-12' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('objectifs.*') ? 'text-white' : 'group-hover:text-[#be2346]' }} transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {{-- ═══════════════ COMMERCIAL SECTION ═══════════════ --}}
            @canany(['client.view', 'lead.view', 'dossier.view', 'category.view'])
            ...
            @can('client.view')
                <a href="{{ Route::has('clients.index') ? route('clients.index') : '/clients' }}" 
                   class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95
                   {{ request()->is('clients*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
                    <div class="transition-transform duration-300 {{ request()->is('clients*') ? '' : 'group-hover:rotate-12' }}">
                        <svg class="w-5 h-5 {{ request()->is('clients*') ? 'text-white' : 'group-hover:text-blue-500' }} transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @can('lead.view')
                <a href="{{ route('leads.index') }}" 
                   class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95
                   {{ request()->routeIs('leads.*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
                    <div class="transition-transform duration-300 {{ request()->routeIs('leads.*') ? '' : 'group-hover:rotate-12' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('leads.*') ? 'text-white' : 'group-hover:text-blue-500' }} transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
            ...
            @can('category.view')
                <a href="{{ route('categories.index') }}" 
                   class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95
                   {{ request()->routeIs('categories.*') || request()->is('categories*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
                    <div class="transition-transform duration-300 {{ request()->routeIs('categories.*') || request()->is('categories*') ? '' : 'group-hover:rotate-12' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('categories.*') || request()->is('categories*') ? 'text-white' : 'group-hover:text-blue-500' }} transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @can('dossier.view')
                <a href="{{ Route::has('dossiers.index') ? route('dossiers.index') : '/dossiers' }}" 
                   class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95
                   {{ request()->is('dossiers*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
                    <div class="transition-transform duration-300 {{ request()->is('dossiers*') ? '' : 'group-hover:rotate-12' }}">
                        <svg class="w-5 h-5 {{ request()->is('dossiers*') ? 'text-white' : 'group-hover:text-blue-500' }} transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @can('paiement.view')
                <a href="{{ route('paiements.index') }}" 
                   class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95
                   {{ request()->routeIs('paiements.*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
                    <div class="transition-transform duration-300 {{ request()->routeIs('paiements.*') ? '' : 'group-hover:rotate-12' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('paiements.*') ? 'text-white' : 'group-hover:text-blue-500' }} transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
