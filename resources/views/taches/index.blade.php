    ...
    <div class="p-8 bg-[#F8FAFC] min-h-screen font-sans text-slate-900" 
         x-data="{ 
            ...
            async fetchTasks(page = 1) {
                this.loading = true;
                const url = `{{ route('tasks.index') }}?view=${this.view}&search=${encodeURIComponent(this.search)}&priority=${this.priority}&status=${this.status}&idDepartement=${this.dept}&idUser=${this.user}&page=${page}`;
