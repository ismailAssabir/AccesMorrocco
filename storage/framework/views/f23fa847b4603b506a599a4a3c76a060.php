<?php $__env->startSection('title', 'Mon Profil — Access Morocco'); ?>
<?php $__env->startSection('page-title', 'Mon Profil'); ?>
<?php $__env->startSection('page-subtitle', 'Gérez vos informations et vos préférences'); ?>
    ...
    <div class="relative bg-white border border-slate-200 rounded-[2.5rem] shadow-sm overflow-hidden group">
        ...
        <div class="px-8 pb-8 pt-0 relative flex flex-col md:flex-row items-end gap-6 -mt-16 md:-mt-12">
            ...
            <div class="flex-1 text-center md:text-left mb-2">
                <h1 class="text-3xl font-black text-slate-800 tracking-tight"><?php echo e($client->firstName); ?> <?php echo e($client->lastName); ?></h1>
            ...
            <div class="flex items-center gap-3 mb-2 shrink-0">
                <div class="px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-center">
                    ...
                    <p class="text-lg font-black text-[#be2346] leading-none mt-0.5"><?php echo e($client->dossiers->count()); ?></p>
                </div>
                <div class="px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-center">
                ...
                <div class="space-y-4">
                    <div class="group">
                        ...
                        <div class="flex items-center gap-3 p-4 bg-slate-50 border border-slate-200 rounded-2xl transition-all group-hover:border-[#be2346]/20 group-hover:bg-[#be2346]/5">
                            ...
                            <span class="text-sm font-bold text-slate-600 truncate"><?php echo e($client->email); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <div class="flex items-center gap-3 p-4 bg-slate-50 border border-slate-200 rounded-2xl transition-all group-hover:border-[#be2346]/20 group-hover:bg-[#be2346]/5">
                            ...
                            <span class="text-sm font-bold text-slate-600"><?php echo e($client->phoneNumber ?? 'Non renseigné'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form action="#" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-1.5">
                                ...
                                <input type="text" value="<?php echo e($client->firstName); ?>" class="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-3.5 text-sm font-bold text-slate-700 outline-none transition-all focus:border-[#be2346] focus:ring-4 focus:ring-[#be2346]/5">
                            </div>
                            <div class="space-y-1.5">
                                <label class="text-[10px] font-black uppercase text-slate-400 tracking-widest ml-1">Nom</label>
                                <input type="text" value="<?php echo e($client->lastName); ?>" class="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-3.5 text-sm font-bold text-slate-700 outline-none transition-all focus:border-[#be2346] focus:ring-4 focus:ring-[#be2346]/5">
                            </div>
                        </div>

                        <div class="space-y-1.5">
                            <label class="text-[10px] font-black uppercase text-slate-400 tracking-widest ml-1">Email Principal</label>
                            <input type="email" value="<?php echo e($client->email); ?>" class="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-3.5 text-sm font-bold text-slate-700 outline-none transition-all focus:border-[#be2346] focus:ring-4 focus:ring-[#be2346]/5">
                        </div>
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ABA SOLUTIONS\Desktop\PROJET STAGE Travel Agency\AccesMorrocco\resources\views/clients/profile.blade.php ENDPATH**/ ?>