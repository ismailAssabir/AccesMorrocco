<x-app-layout>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white border border-slate-200 rounded-3xl shadow-sm p-6 flex flex-col justify-between hover:shadow-xl transition-all duration-300 relative group">
                ...
                <div class="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <form action="/objectifs/delete/{{ $obj->idObjectif }}" method="POST" onsubmit="return confirm('Supprimer cet objectif ?')">
                        @csrf
                        @method('DELETE')
    ...
    <script>
        ...
        function openEditModal(obj) {
            ...
            document.getElementById('edit_dateDebut').value = obj.dateDebut ? obj.dateDebut.split(' ')[0] : '';
            document.getElementById('edit_dateFin').value = obj.dateFin ? obj.dateFin.split(' ')[0] : '';
