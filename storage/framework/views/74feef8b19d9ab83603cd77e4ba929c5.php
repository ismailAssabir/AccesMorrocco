        ...
        <div class="content">
            ...
            <div class="prime-card">
                ...
                <div class="prime-details">
                    <strong>Motif :</strong> <?php echo e($prime->motif ?? 'Performance exceptionnelle'); ?><br>
                    <strong>Date d'attribution :</strong> <?php echo e(\Carbon\Carbon::parse($prime->dateAttribution)->format('d/m/Y')); ?>
            ...
            <div style="text-align: center; margin-top: 40px;">
                <a href="<?php echo e(url('/primes')); ?>" class="btn">Voir mes primes</a>
            </div>
        </div>
        <div class="footer">
...
<?php /**PATH C:\Users\ABA SOLUTIONS\Desktop\PROJET STAGE Travel Agency\AccesMorrocco\resources\views/emails/prime_validated.blade.php ENDPATH**/ ?>