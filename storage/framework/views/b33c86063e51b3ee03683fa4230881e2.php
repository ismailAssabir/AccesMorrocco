                ...
                <div class="flex flex-wrap items-center gap-3">
                    <div class="relative">
                        <select name="status"
                            ...
                            <option value="present" <?php echo e(request('status') == 'present' ? 'selected' : ''); ?>>Présent
                            </option>
                    ...
                    <div class="relative">
                        <select name="role"
                            ...
                            <option value="employee" <?php echo e(request('role') == 'employee' ? 'selected' : ''); ?>>Employé
                            </option>
                        </select>
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                            <svg class="h-3 w-3 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="relative">
                        <select name="departement"
                            ...
                            <?php $__currentLoopData = \App\Models\Departement::orderBy('title')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($dept->title); ?>" <?php echo e(request('departement') == $dept->title ? 'selected' : ''); ?>><?php echo e($dept->title); ?></option>
                                        ...
                                        <div>
                                            ...
                                            <?php if($user): ?>
                                                <div class="flex items-center gap-2 mt-0.5">
                                                    <p class="text-[10px] text-slate-400 font-medium"><?php echo e($user->email ?? ''); ?>
