            ...
            <form action="<?php echo e(route('departements.store')); ?>" method="POST" class="p-7 space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="title" id="dept_title" required value="<?php echo e(old('title')); ?>"
                           ...
                           class="w-full bg-slate-50 border border-slate-200 rounded-2xl px-4 py-3 text-sm outline-none transition-all focus:border-[#be2346] focus:ring-4 focus:ring-[#be2346]/5 <?php $__errorArgs = ['title'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea name="description" id="dept_description" rows="3"
                              ...
                              class="w-full bg-slate-50 border border-slate-200 rounded-2xl px-4 py-3 text-sm outline-none transition-all resize-none focus:border-[#be2346] focus:ring-4 focus:ring-[#be2346]/5 <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative">
                        <select name="idUser" id="dept_manager"
                                class="w-full bg-slate-50 border border-slate-200 rounded-2xl px-4 py-3 text-sm outline-none transition-all appearance-none focus:border-[#be2346] focus:ring-4 focus:ring-[#be2346]/5 <?php $__errorArgs = ['idUser'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
<?php /**PATH C:\Users\Legion UCGS.ma\Desktop\project\AccesMorrocco\resources\views/departements/create.blade.php ENDPATH**/ ?>