                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors group">
                        ...
                        <td class="px-6 py-4 flex justify-end gap-3">
                            ...
                            <form action="/reclamation/delete/{{ $rec->idReclamation }}" method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer cette réclamation ?')">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="p-2 rounded-lg text-slate-400 hover:bg-red-50 hover:text-red-600 transition-all">
