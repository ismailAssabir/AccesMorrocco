            ...
            <form id="editDepartmentForm" action="<?php echo e(old('edit_url', '#')); ?>" method="POST" class="p-7 space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="title" id="edit_dept_title" required value="<?php echo e(old('title')); ?>"
                           class="w-full bg-slate-50 border <?php echo e(($errors->has('title') && old('_method') === 'PUT') ? 'border-red-400' : 'border-slate-200'); ?> rounded-2xl px-4 py-3 text-sm outline-none transition-all focus:border-[#be2346] focus:ring-4 focus:ring-[#be2346]/5">
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea name="description" id="edit_dept_description" rows="3"
                              class="w-full bg-slate-50 border <?php echo e(($errors->has('description') && old('_method') === 'PUT') ? 'border-red-400' : 'border-slate-200'); ?> rounded-2xl px-4 py-3 text-sm outline-none transition-all resize-none focus:border-[#be2346] focus:ring-4 focus:ring-[#be2346]/5"><?php echo e(old('description')); ?></textarea>
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative">
                        <select name="idUser" id="edit_dept_manager"
                                class="w-full bg-slate-50 border <?php echo e(($errors->has('idUser') && old('_method') === 'PUT') ? 'border-red-400' : 'border-slate-200'); ?> rounded-2xl px-4 py-3 text-sm outline-none transition-all appearance-none focus:border-[#be2346] focus:ring-4 focus:ring-[#be2346]/5">
...
<script>
    function openEditDeptModal(id) {
        // Build the URLs
        const editUrl = '<?php echo e(url("/departements")); ?>/' + id + '/edit';
        const updateUrl = '<?php echo e(url("/departements")); ?>/' + id;
...
<?php /**PATH C:\Users\ABA SOLUTIONS\Desktop\PROJET STAGE Travel Agency\AccesMorrocco\resources\views/departements/edit_modal.blade.php ENDPATH**/ ?>