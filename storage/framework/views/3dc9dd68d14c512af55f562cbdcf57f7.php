                ...
                <tr class="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td class="px-5 py-4">
                        <div class="flex items-center gap-3">
                            <div class="w-9 h-9 rounded-xl <?php echo e($avatarColors[$loop->index % count($avatarColors)]); ?> flex items-center justify-center shrink-0">
                            ...
                            <div class="min-w-0">
                                <p class="font-bold text-slate-800 text-sm truncate"><?php echo e($lead->firstName); ?> <?php echo e($lead->lastName); ?></p>
                    ...
                    <td class="px-5 py-4">
                        <p class="text-slate-700 text-xs font-medium truncate"><?php echo e($lead->email ?? '—'); ?></p>
                        <p class="text-slate-400 text-xs mt-0.5"><?php echo e($lead->phoneNumber ?? '—'); ?></p>
                    </td>

                    
                    <td class="px-5 py-4">
                        <span class="px-2.5 py-1 rounded-xl text-xs font-black bg-[#b11d40]/10 text-[#b11d40] uppercase">
                            <?php echo e(\Illuminate\Support\Str::limit($lead->type, 12)); ?>
                    ...
                    <td class="px-5 py-4">
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl text-xs font-black <?php echo e($statutColors[$lead->statut] ?? 'bg-slate-100 text-slate-500'); ?>">
                            <?php if($lead->statut === 'ok'): ?>
                                <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/>
                                </svg>
                            <?php elseif($lead->statut === 'lost'): ?>
                                <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <td class="px-5 py-4 text-slate-500 text-xs font-medium"><?php echo e($lead->source ?? '—'); ?></td>

                    
                    <td class="px-5 py-4 text-slate-500 text-xs font-medium"><?php echo e($lead->departements->title ?? '—'); ?></td>
                    ...
                    <td class="px-5 py-4">
                        <div class="flex items-center justify-end gap-1">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('lead.edit')): ?>
                            <?php if($lead->statut !== 'ok' && $lead->statut !== 'lost'): ?>
                            <button onclick="openStatutModal(<?php echo e($lead->idLead); ?>, '<?php echo e($lead->statut); ?>')"
