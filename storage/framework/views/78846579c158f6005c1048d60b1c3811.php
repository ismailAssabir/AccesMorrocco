            ...
            <div class="px-8 pt-8 pb-6 flex items-center justify-between border-b border-slate-50">
                <div>
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        ...
                        <?php if(auth('client')->check() && auth('client')->user()->type !== 'employee'): ?>
...
<?php /**PATH C:\Users\ABA SOLUTIONS\Desktop\PROJET STAGE Travel Agency\AccesMorrocco\resources\views/components/pointage-modal.blade.php ENDPATH**/ ?>