...
<div class="p-8 min-h-screen" x-data="leadsKanban()">
    ...
    <form method="GET" action="<?php echo e(route('leads.index')); ?>" x-data
        ...
        <div class="flex flex-nowrap items-center gap-3 overflow-x-auto pb-2 custom-scrollbar">
            ...
            <div class="relative shrink-0">
                <select name="source" onchange="this.form.submit()"
                    ...
                    <?php $__currentLoopData = $sources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($source); ?>" <?php echo e(request('source') === $source ? 'selected' : ''); ?>><?php echo e($source); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                    <svg class="h-3 w-3 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M19 9l-7 7-7-7" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
            ...
            <div class="relative shrink-0">
                ...
                <input type="text" name="nationalite" value="<?php echo e(request('nationalite')); ?>"
                       @input.debounce.500ms="$el.closest('form').submit()"
            ...
            <?php if(request('search') || request('type') || request('source') || request('nationalite')): ?>
            <div class="flex shrink-0">
                <a href="<?php echo e(route('leads.index')); ?>" title="Réinitialiser" class="p-2 rounded-xl bg-slate-100 text-slate-500 hover:bg-slate-200 hover:text-slate-800 transition-all flex items-center justify-center shadow-sm">
        ...
        <div class="flex flex-col gap-3 min-w-0">
            ...
            <div class="flex items-center justify-between px-2">
                <h2 class="text-xs font-black uppercase tracking-wider text-slate-400 flex items-center gap-2 whitespace-nowrap truncate">
                    <span class="w-2 h-2 rounded-full shrink-0 <?php echo e($col['dot']); ?>"></span>
                    <span class="truncate"><?php echo e($col['label']); ?></span>
                </h2>
                <span class="<?php echo e($col['badge']); ?> text-[10px] font-bold px-2 py-0.5 rounded-full shrink-0 ml-2">
            ...
            <div class="flex flex-col gap-4 min-h-[300px]"
                ...
                <div x-show="<?php echo e($i); ?> >= (page-1)*perPage && <?php echo e($i); ?> < page*perPage"
                    ...
                    <div class="absolute left-0 top-6 bottom-6 w-1.5 <?php echo e(str_replace('bg-', '', $col['dot'])); ?> bg-opacity-70 bg-gradient-to-b from-<?php echo e(str_replace('bg-', '', $col['dot'])); ?> to-slate-200 rounded-r-full shadow-[0_0_10px_rgba(0,0,0,0.1)]" style="background-color: var(--fallback, currentColor); border-left: 4px solid inherit;"></div>
                    <div class="absolute left-0 top-6 bottom-6 w-1.5 <?php echo e($col['dot']); ?> rounded-r-full shadow-[0_0_10px_rgba(0,0,0,0.1)]"></div>
                    ...
                    <div class="flex items-start justify-between gap-2 mb-3 pl-2">
                        <div class="flex items-center gap-2 min-w-0">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-[10px] text-slate-400 font-medium truncate"><?php echo e($lead->nationalite); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                ...
                <div class="p-8 border-2 border-dashed border-slate-200 rounded-[24px] flex flex-col items-center justify-center text-slate-400 min-h-[150px]">
                    <svg class="w-8 h-8 mb-3 text-slate-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo e($col['svgPath']); ?>"/>
                    </svg>
...
<?php endif; ?><?php /**PATH C:\Users\dell\Desktop\AccesMorrocco\resources\views/leads/index.blade.php ENDPATH**/ ?>