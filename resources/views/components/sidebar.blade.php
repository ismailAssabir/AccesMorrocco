<aside class="sidebar-wrapper w-72 h-screen sticky top-0 bg-[#0F1115] text-white flex flex-col font-sans border-r border-white/5 shadow-2xl">
    ...
    <div class="flex-1 overflow-y-auto custom-scrollbar min-h-0 px-4">
        ...
        <nav class="space-y-1">
            @can('user.view')
                <a href="{{ url('/users') }}" class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95 {{ request()->is('users*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
            ...
            @can('departement.view')
                <a href="/departements" class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95 {{ request()->is('departements*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
            ...
            @can('pointage.view')
                <a href="{{ Route::has('pointages.index') ? route('pointages.index') : '#' }}" class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95 {{ request()->routeIs('pointages.*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
                    <div class="transition-transform duration-300 {{ request()->routeIs('pointages.*') ? '' : 'group-hover:rotate-12' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('pointages.*') ? 'text-white' : 'group-hover:text-[#be2346]' }} transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @can('reclamation.view')
                <a href="/reclamations" class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95 {{ request()->is('reclamations*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
        ...
        {{-- ═══════════════ COMMERCIAL SECTION ═══════════════ --}}
        @canany(['client.view', 'lead.view', 'category.view'])
            ...
            <nav class="space-y-1">
                @can('lead.view')
                <a href="{{ route('leads.index') }}" class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95 {{ request()->routeIs('leads.*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
        ...
        @can('permission.view')
            ...
            <nav class="space-y-1 mb-6">
                <a href="{{ route('permissions.index') }}" class="group flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 active:scale-95 {{ request()->routeIs('permissions.*') ? 'bg-[#be2346] text-white shadow-lg shadow-[#be2346]/20' : 'text-white/50 hover:bg-white/5 hover:text-white hover:translate-x-1' }}">
