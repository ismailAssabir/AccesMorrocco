                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        ...
                        <div>
                            ...
                            <input name="firstName" required value="<?php echo e(old('firstName', $client->firstName)); ?>"
                                   class="w-full px-3 py-2.5 bg-slate-50 border <?php echo e($errors->has('firstName') ? 'border-red-400' : 'border-slate-200'); ?> rounded-xl text-sm text-slate-700 focus:outline-none focus:border-[#b11d40] focus:ring-1 focus:ring-[#b11d40]">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input name="lastName" required value="<?php echo e(old('lastName', $client->lastName)); ?>"
                                   class="w-full px-3 py-2.5 bg-slate-50 border <?php echo e($errors->has('lastName') ? 'border-red-400' : 'border-slate-200'); ?> rounded-xl text-sm text-slate-700 focus:outline-none focus:border-[#b11d40] focus:ring-1 focus:ring-[#b11d40]">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input name="email" type="email" required value="<?php echo e(old('email', $client->email)); ?>"
                                   class="w-full px-3 py-2.5 bg-slate-50 border <?php echo e($errors->has('email') ? 'border-red-400' : 'border-slate-200'); ?> rounded-xl text-sm text-slate-700 focus:outline-none focus:border-[#b11d40] focus:ring-1 focus:ring-[#b11d40]">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input name="CNE" required value="<?php echo e(old('CNE', $client->CNE)); ?>"
                                   class="w-full px-3 py-2.5 bg-slate-50 border <?php echo e($errors->has('CNE') ? 'border-red-400' : 'border-slate-200'); ?> rounded-xl text-sm text-slate-700 focus:outline-none focus:border-[#b11d40] focus:ring-1 focus:ring-[#b11d40]">
                            <?php $__errorArgs = ['CNE'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input name="phoneNumber" required value="<?php echo e(old('phoneNumber', $client->phoneNumber)); ?>"
                                   class="w-full px-3 py-2.5 bg-slate-50 border <?php echo e($errors->has('phoneNumber') ? 'border-red-400' : 'border-slate-200'); ?> rounded-xl text-sm text-slate-700 focus:outline-none focus:border-[#b11d40] focus:ring-1 focus:ring-[#b11d40]">
                        ...
                        <div>
                            ...
                            <select name="type_select" id="type-select" required
                                onchange="
                                    ...
                                    "
                                class="w-full px-3 py-2.5 bg-slate-50 border <?php echo e($errors->has('type') ? 'border-red-400' : 'border-slate-200'); ?> rounded-xl text-sm text-slate-700 focus:outline-none focus:border-[#b11d40] focus:ring-1 focus:ring-[#b11d40]">
...
<?php endif; ?><?php /**PATH C:\Users\ABA SOLUTIONS\Desktop\PROJET STAGE Travel Agency\AccesMorrocco\resources\views/editClient.blade.php ENDPATH**/ ?>