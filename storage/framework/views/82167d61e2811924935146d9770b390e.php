    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden">
            ...
            <div class="p-8">
                ...
                <form method="POST" action="<?php echo e(route('client.password.reset')); ?>" class="space-y-5">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\4B\Desktop\ExercicesLaravel\voyage\resources\views/clients/auth/reset-password.blade.php ENDPATH**/ ?>